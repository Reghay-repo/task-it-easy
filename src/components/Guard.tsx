        ...
        return (
            <div className="flex h-screen w-screen items-center justify-center bg-skin-base">
                <div className="flex flex-row space-x-2">
                    <div className="h-5 w-5 animate-bounce rounded-full bg-yellow-700"></div>
                    <div className="h-5 w-5 animate-bounce rounded-full bg-red-700 delay-100"></div>
                    <div className="h-5 w-5 animate-bounce rounded-full bg-purple-700 delay-200"></div>
                </div>
            </div>
        );
